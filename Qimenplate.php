...
class Qimenplate {
    ...
    */
    ...
    // 判斷五不遇時（時干克日干，陽克陽陰克陰）
    private function isWuBuYuShi($dayGan, $hourGan) {
        $ganWuXing = [
            '甲'=>'木','乙'=>'木','丙'=>'火','丁'=>'火',
        ...
        $ganYinYang = [
            '甲'=>'陽','乙'=>'陰','丙'=>'陽','丁'=>'陰',
            '戊'=>'陽','己'=>'陰','庚'=>'陽','辛'=>'陰','壬'=>'陽','癸'=>'陰'
        ];
        
        $dayXing = $ganWuXing[$dayGan];
        $hourXing = $ganWuXing[$hourGan];
        ...
        if ($keRelation[$hourXing] == $dayXing) {
            // 陰陽相同
            if ($ganYinYang[$dayGan] == $ganYinYang[$hourGan]) {
                return true;
            }
        }
        return false;
